...
namespace BracketSpace\Notification\Signature\Dependencies\Composer\ClassMapGenerator;
...
class ClassMapGenerator
{
     ...
     *
     * @see BracketSpace\Notification\Signature\Dependencies\Composer\Util\Filesystem::isAbsolutePath
     *
     * @param  string $path
     * @return bool
     */
     ...
     *
     * @see BracketSpace\Notification\Signature\Dependencies\Composer\Util\Filesystem::normalizePath
     *
    ...
    /**
     * @see BracketSpace\Notification\Signature\Dependencies\Composer\Util\Platform::getCwd
     */
