...
class RepositoryManager
{
     ...
     * @param string|\BracketSpace\Notification\Signature\Dependencies\Composer\Semver\Constraint\ConstraintInterface $constraint package version or version constraint to match against
     */
