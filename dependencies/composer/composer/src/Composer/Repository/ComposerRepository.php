...
use BracketSpace\Notification\Signature\Dependencies\Composer\Advisory\PartialSecurityAdvisory;
use BracketSpace\Notification\Signature\Dependencies\Composer\Advisory\SecurityAdvisory;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Version\StabilityFilter;
use BracketSpace\Notification\Signature\Dependencies\Composer\Json\JsonFile;
use BracketSpace\Notification\Signature\Dependencies\Composer\Cache;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Plugin\PostFileDownloadEvent;
use BracketSpace\Notification\Signature\Dependencies\Composer\Semver\CompilingMatcher;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Plugin\PreFileDownloadEvent;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Semver\Constraint\MatchAllConstraint;
use BracketSpace\Notification\Signature\Dependencies\Composer\Util\Http\Response;
use BracketSpace\Notification\Signature\Dependencies\Composer\MetadataMinifier\MetadataMinifier;
...
class ComposerRepository extends ArrayRepository implements ConfigurableRepositoryInterface, AdvisoryProviderInterface
{
    ...
    private function asyncFetchFile(string $filename, string $cacheKey, ?string $lastModifiedTime = null): PromiseInterface
    {
        ...
        if (isset($this->packagesNotFoundCache[$filename])) {
            return \BracketSpace\Notification\Signature\Dependencies\React\Promise\resolve(['packages' => []]);
        }
        ...
        if (isset($this->freshMetadataUrls[$filename]) && $lastModifiedTime) {
            ...
            $promise = \BracketSpace\Notification\Signature\Dependencies\React\Promise\resolve(true);
