...
class RepositoryFactory
{
    ...
    public static function manager(IOInterface $io, Config $config, ?HttpDownloader $httpDownloader = null, ?EventDispatcher $eventDispatcher = null, ?ProcessExecutor $process = null): RepositoryManager
    {
        ...
        $rm->setRepositoryClass('composer', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\ComposerRepository');
        $rm->setRepositoryClass('vcs', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('package', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\PackageRepository');
        $rm->setRepositoryClass('pear', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\PearRepository');
        $rm->setRepositoryClass('git', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('bitbucket', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('git-bitbucket', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('github', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('gitlab', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('svn', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('fossil', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('perforce', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('hg', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('artifact', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\ArtifactRepository');
        $rm->setRepositoryClass('path', 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\PathRepository');
