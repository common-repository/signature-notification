...
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\VcsDriverInterface;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Loader\ValidatingArrayLoader;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Loader\InvalidPackageException;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Loader\LoaderInterface;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Util\Url;
...
class VcsRepository extends ArrayRepository implements ConfigurableRepositoryInterface
{
    ...
    public function __construct(array $repoConfig, IOInterface $io, Config $config, HttpDownloader $httpDownloader, ?EventDispatcher $dispatcher = null, ?ProcessExecutor $process = null, ?array $drivers = null, ?VersionCacheInterface $versionCache = null)
    {
        ...
        $this->drivers = $drivers ?: [
            'github' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\GitHubDriver',
            'gitlab' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\GitLabDriver',
            'bitbucket' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\GitBitbucketDriver',
            'git-bitbucket' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\GitBitbucketDriver',
            'git' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\GitDriver',
            'hg' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\HgDriver',
            'perforce' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\PerforceDriver',
            'fossil' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\FossilDriver',
            // svn must be last because identifying a subversion server for sure is practically impossible
            'svn' => 'BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\SvnDriver',
        ];
    ...
    /**
     * @return \BracketSpace\Notification\Signature\Dependencies\Composer\Package\CompletePackage|\BracketSpace\Notification\Signature\Dependencies\Composer\Package\CompleteAliasPackage|null|false null if no cache present, false if the absence of a version was cached
     */
