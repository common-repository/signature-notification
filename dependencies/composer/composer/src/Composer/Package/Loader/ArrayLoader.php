...
class ArrayLoader implements LoaderInterface
{
    ...
    {
        if ($class !== 'BracketSpace\Notification\Signature\Dependencies\Composer\Package\CompletePackage' && $class !== 'BracketSpace\Notification\Signature\Dependencies\Composer\Package\RootPackage') {
    ...
    public function loadPackages(array $versions): array
    {
        ...
        foreach ($versions as $version) {
            $package = $this->createObject($version, 'BracketSpace\Notification\Signature\Dependencies\Composer\Package\CompletePackage');
