...
class RootPackageLoader extends ArrayLoader
{
     ...
     */
    public function load(array $config, string $class = 'BracketSpace\Notification\Signature\Dependencies\Composer\Package\RootPackage', ?string $cwd = null): BasePackage
    {
        if ($class !== 'BracketSpace\Notification\Signature\Dependencies\Composer\Package\RootPackage') {
