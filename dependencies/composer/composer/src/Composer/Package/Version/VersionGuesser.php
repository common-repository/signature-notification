...
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\Vcs\HgDriver;
use BracketSpace\Notification\Signature\Dependencies\Composer\IO\NullIO;
use BracketSpace\Notification\Signature\Dependencies\Composer\Semver\VersionParser as SemverVersionParser;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Util\Svn as SvnUtil;
use BracketSpace\Notification\Signature\Dependencies\React\Promise\CancellablePromiseInterface;
                        ...
                        if (strlen($output) < $length) {
                            ...
                            if ($length === 0) {
                                foreach ($promises as $promise) {
                                    ...
                                    \BracketSpace\Notification\Signature\Dependencies\React\Promise\resolve($promise)->cancel();
                                }
                            }
                        }
                    });
