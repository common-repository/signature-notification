...
use BracketSpace\Notification\Signature\Dependencies\Composer\Config\ConfigSourceInterface;
...
class Config
{
     ...
     * "scripts": {
     *   "watch": [
     *     "BracketSpace\\Notification\\Signature\\Dependencies\\Composer\\Config::disableProcessTimeout",
