...
abstract class ArchiveDownloader extends FileDownloader
{
    ...
    public function install(PackageInterface $package, string $path, bool $output = true): PromiseInterface
    {
        ...
        return $promise->then(function () use ($package, $filesystem, $fileName, $temporaryDir, $path): \BracketSpace\Notification\Signature\Dependencies\React\Promise\PromiseInterface {
