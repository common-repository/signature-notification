...
use BracketSpace\Notification\Signature\Dependencies\Composer\ClassMapGenerator\FileList;
...
class ClassMapGenerator
{
    ...
    {
        $generator = new \BracketSpace\Notification\Signature\Dependencies\Composer\ClassMapGenerator\ClassMapGenerator(['php', 'inc', 'hh']);
