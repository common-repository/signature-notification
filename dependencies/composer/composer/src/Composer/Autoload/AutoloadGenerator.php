...
namespace BracketSpace\Notification\Signature\Dependencies\Composer\Autoload;

use BracketSpace\Notification\Signature\Dependencies\Composer\ClassMapGenerator\ClassMap;
use BracketSpace\Notification\Signature\Dependencies\Composer\ClassMapGenerator\ClassMapGenerator;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Semver\Constraint\Bound;
...
EOF;
        ...
        $classMap->addClass('BracketSpace\Notification\Signature\Dependencies\Composer\InstalledVersions', $vendorPath . '/composer/InstalledVersions.php');
        $classMap->sort();
...
class ComposerAutoloaderInit$suffix
{
    ...
    {
        if ('BracketSpace\\Notification\\Signature\\Dependencies\\Composer\\Autoload\\ClassLoader' === \$class) {
            require __DIR__ . '/ClassLoader.php';
        }
    }

    /**
     * @return \BracketSpace\Notification\Signature\Dependencies\Composer\Autoload\ClassLoader
     */
...
PLATFORM_CHECK;
        ...
        self::\$loader = \$loader = new \\BracketSpace\\Notification\\Signature\\Dependencies\\Composer\\Autoload\\ClassLoader(\\dirname(__DIR__));
...
INCLUDE_PATH;
        ...
        call_user_func(\BracketSpace\Notification\Signature\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::getInitializer(\$loader));
...
REGISTER_LOADER;
        ...
        if ($useIncludeFiles) {
            $file .= <<<INCLUDE_FILES
        \$filesToLoad = \BracketSpace\Notification\Signature\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::\$files;
