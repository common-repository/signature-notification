...
namespace BracketSpace\Notification\Signature\Dependencies\Composer\EventDispatcher;

use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\Transaction;
use BracketSpace\Notification\Signature\Dependencies\Composer\Installer\InstallerEvent;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\PartialComposer;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Plugin\PreCommandRunEvent;
use BracketSpace\Notification\Signature\Dependencies\Composer\Util\Platform;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\Operation\OperationInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\RepositoryInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Script;
use BracketSpace\Notification\Signature\Dependencies\Composer\Installer\PackageEvent;
use BracketSpace\Notification\Signature\Dependencies\Composer\Installer\BinaryInstaller;
use BracketSpace\Notification\Signature\Dependencies\Composer\Util\ProcessExecutor;
use BracketSpace\Notification\Signature\Dependencies\Composer\Script\Event as ScriptEvent;
use BracketSpace\Notification\Signature\Dependencies\Composer\Autoload\ClassLoader;
use BracketSpace\Notification\Signature\Dependencies\Symfony\Component\Console\Application;
...
use BracketSpace\Notification\Signature\Dependencies\Symfony\Component\Process\PhpExecutableFinder;
        ...
        try {
            ...
            foreach ($listeners as $callable) {
                ...
                if (!is_string($callable)) {
                    ...
                    if (defined('BracketSpace\Notification\Signature\Dependencies\Composer\Script\ScriptEvents::'.str_replace('-', '_', strtoupper($event->getName())))) {
                    ...
                    $args = implode(' ', array_map(['BracketSpace\Notification\Signature\Dependencies\Composer\Util\ProcessExecutor', 'escape'], $event->getArguments()));
