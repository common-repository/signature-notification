...
use BracketSpace\Notification\Signature\Dependencies\Composer\Autoload\AutoloadGenerator;
use BracketSpace\Notification\Signature\Dependencies\Composer\Console\GithubActionError;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\DefaultPolicy;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\LocalRepoTransaction;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\LockTransaction;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\PoolOptimizer;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\Pool;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\Request;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\Solver;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\SolverProblemsException;
use BracketSpace\Notification\Signature\Dependencies\Composer\DependencyResolver\PolicyInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Downloader\DownloadManager;
use BracketSpace\Notification\Signature\Dependencies\Composer\Downloader\TransportException;
use BracketSpace\Notification\Signature\Dependencies\Composer\EventDispatcher\EventDispatcher;
use BracketSpace\Notification\Signature\Dependencies\Composer\Filter\PlatformRequirementFilter\IgnoreListPlatformRequirementFilter;
use BracketSpace\Notification\Signature\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterFactory;
use BracketSpace\Notification\Signature\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Installer\InstallationManager;
use BracketSpace\Notification\Signature\Dependencies\Composer\Installer\InstallerEvents;
use BracketSpace\Notification\Signature\Dependencies\Composer\Installer\SuggestedPackagesReporter;
use BracketSpace\Notification\Signature\Dependencies\Composer\IO\IOInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\AliasPackage;
...
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\CompletePackageInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Link;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Loader\ArrayLoader;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Dumper\ArrayDumper;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Version\VersionParser;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Package;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\ArrayRepository;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\RepositorySet;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\CompositeRepository;
use BracketSpace\Notification\Signature\Dependencies\Composer\Semver\Constraint\Constraint;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\Locker;
use BracketSpace\Notification\Signature\Dependencies\Composer\Package\RootPackageInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\InstalledArrayRepository;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\InstalledRepositoryInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\InstalledRepository;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\RootPackageRepository;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\PlatformRepository;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\RepositoryInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\RepositoryManager;
use BracketSpace\Notification\Signature\Dependencies\Composer\Repository\LockArrayRepository;
use BracketSpace\Notification\Signature\Dependencies\Composer\Script\ScriptEvents;
use BracketSpace\Notification\Signature\Dependencies\Composer\Semver\Constraint\ConstraintInterface;
use BracketSpace\Notification\Signature\Dependencies\Composer\Advisory\Auditor;
...
class Installer
{
    ...
    protected function doUpdate(InstalledRepositoryInterface $localRepo, bool $doInstall): int
    {
        ...
        } catch (\BracketSpace\Notification\Signature\Dependencies\Seld\JsonLint\ParsingException $e) {
            if ($this->updateAllowList !== null || $this->updateMirrors) {
        ...
        \BracketSpace\Notification\Signature\Dependencies\Composer\Semver\CompilingMatcher::clear();
