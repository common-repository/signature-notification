...
namespace BracketSpace\Notification\Signature\Dependencies\Micropackage\Templates;

use BracketSpace\Notification\Signature\Dependencies\Micropackage\Templates\Exceptions\TemplateException;
use BracketSpace\Notification\Signature\Dependencies\Micropackage\Templates\Exceptions\StorageException;
...
class Template {
	 ...
	 * Filesystem instance
	 *
	 * @var BracketSpace\Notification\Signature\Dependencies\Micropackage\Filesystem\Filesystem
	 */
	private $fs;
