...
namespace BracketSpace\Notification\Signature\Dependencies\MyCLabs\Enum\PHPUnit;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \BracketSpace\Notification\Signature\Dependencies\MyCLabs\Enum\PHPUnit\Comparator());
 */
