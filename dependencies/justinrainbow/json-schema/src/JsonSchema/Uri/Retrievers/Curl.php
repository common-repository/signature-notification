...
class Curl extends AbstractRetriever
{
     ...
     * {@inheritdoc}
     *
     * @see \BracketSpace\Notification\Signature\Dependencies\JsonSchema\Uri\Retrievers\UriRetrieverInterface::retrieve()
     */
    public function retrieve($uri)
    {
        ...
        if (false === $response) {
            throw new \BracketSpace\Notification\Signature\Dependencies\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found');
        }
