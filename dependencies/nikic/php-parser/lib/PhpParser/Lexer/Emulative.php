...
namespace BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer;
...
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use BracketSpace\Notification\Signature\Dependencies\PhpParser\Lexer\TokenEmulator\TokenEmulator;
